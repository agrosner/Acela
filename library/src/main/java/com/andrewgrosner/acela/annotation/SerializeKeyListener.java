...
/**
 * Description: Marks an accessible method as listening for a specific key event during serialization.
 * The method name must resemble:
 * void onSerialize{keyName}(ParserWrapper wrapper)
 */
@Retention(RetentionPolicy.SOURCE)
@Target(ElementType.METHOD)
public @interface SerializeKeyListener {
